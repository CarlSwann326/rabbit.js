...
PushSocket.prototype.write = function(chunk, encoding, priority) {
...
WorkerSocket.prototype.connect = function(source, callback) {
  ...
  if (this.options.noCreate) {
    ...
    if (this.options.maxPriority) {
      options.maxPriority = this.options.maxPriority;
    }
    ch.assertQueue(source, {
      durable: this.options.persistent,
      maxPriority: this.options.maxPriority
...
ReqSocket.prototype.write = function(chunk, encoding, priority) {
...
RepSocket.prototype.write = function(chunk, encoding, priority) {
...
TaskSocket.prototype.write = function(chunk, encoding, priority) {
  return this.post(false, chunk, encoding, priority);
};

TaskSocket.prototype.post = function(task, chunk, encoding, priority) {
